// File: ContentDeliveryException.cs
// Copyright (c) 2018-2019 Maksym Shnurenok
// License: MIT
using System;

namespace Marketplace.Services.ContentDelivery.Exceptions
{
    /// <summary>
    ...
    public class ContentDeliveryException : Exception
    {
        ...
        /// </summary>
        public ContentDeliveryException() { }
        ...
        public ContentDeliveryException(string message, Exception innerException) :
